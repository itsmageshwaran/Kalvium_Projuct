...
export default function DeclineReasonModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-kalvium-text/40 dark:bg-black/60 backdrop-blur-sm animate-fade-in">
      {/* Modal card — capped at 90vh so it never clips off-screen */}
      <div className="relative w-full max-w-lg bg-white dark:bg-kalvium-dark-surface border border-kalvium-border dark:border-kalvium-dark-border rounded-2xl shadow-kalvium-lg text-kalvium-text dark:text-kalvium-dark-text animate-scale-in flex flex-col max-h-[90vh]">

        {/* ── Sticky header ── */}
        <div className="shrink-0 px-6 pt-6 pb-4 border-b border-kalvium-border dark:border-kalvium-dark-border">
          ...
          <p className="text-xs text-kalvium-muted dark:text-kalvium-dark-muted mt-3">
        ...
        {/* ── Sticky footer ── */}
        <div className="shrink-0 px-6 py-4 border-t border-kalvium-border dark:border-kalvium-dark-border flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
